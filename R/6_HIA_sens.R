#-----------------------------------------------------------------------------#
#              6. Attributable mortality indicators (sensitivity)             #
#-----------------------------------------------------------------------------#
...
# 1. RRs Chen et al. (2021) ----
set.seed(1234)
point_RR10 <- 1.021
nsim <- 200
sim_RR10 <- exp(rnorm(nsim, mean = log(point_RR10), sd = log(1.024/1.018)/(qnorm(0.975)*2)))
...
write_csv(attr_nuts, paste0(pathroot, "data/processed/attributable_nuts_sens.csv"))
...
write_csv(attr_country, paste0(pathroot, "data/processed/attributable_country_sens.csv"))
...
write_csv(attributable_region, paste0(pathroot, "data/processed/attributable_region_sens.csv"))
...
write_csv(attr_euro, paste0(pathroot, "data/processed/attributable_euro_sens.csv"))
